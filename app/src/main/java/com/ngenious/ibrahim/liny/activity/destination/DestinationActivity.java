package com.ngenious.ibrahim.liny.activity.destination;
...
public class DestinationActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
   /* private static String TAG = "DestinationActivity";
        ...
        currentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mGoogleApiClient.isConnected()) {
                    if (ContextCompat.checkSelfPermission(DestinationActivity.this,
